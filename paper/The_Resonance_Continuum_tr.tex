...
\title{The Resonance Continuum: Kavramsal Bir Çerçeve}
...
\begin{abstract}
Bu çalışma, The Resonance Continuum'i Resonance Data ve QIRC paradigması içinde yeni bir kavramsal çerçeve olarak tanıtmaktadır.
